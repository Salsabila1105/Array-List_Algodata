...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // seed
        students.add(new Student("20200040031", "Salsabila"));
        students.add(new Student("20200040031", "Maulani"));
        books.add(new Book("1", "Dantalian"));
        books.add(new Book("2", "High School Examen"));
